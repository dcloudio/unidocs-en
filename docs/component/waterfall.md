...
In nvue, it is impossible to reuse and release invisible rendering resources by using ordinary view as waterfall flow. Using the waterfall component, the native engine will automatically optimize the performance after specifying the cell.
