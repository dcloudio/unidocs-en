...
It is a special tag, somewhat similar to the header tag in html. The background color of the page and the parameters of the native navigation bar can all be written in `page-meta`. HBuilderX 2.6.3+ supports this component on nearly all platforms.
...
From HBuilderX 2.6.3+, `page-meta` can be compiled to all platforms.
