...
|resolveDirective|如果在当前应用实例中可用，则允许通过其名称解析一个 `directive`。返回一个 `Directive`。如果没有找到，则返回 `undefined`。[详情](https://vue3js.cn/docs/zh/api/global-api.html#resolvedirective)	|√	|x	|
